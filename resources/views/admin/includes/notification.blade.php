...
<div class="d-flex  ml-auto header-right-icons header-search-icon">
    ...
    <div class="dropdown profile-1">
        <a href="#" data-toggle="dropdown" class="nav-link pr-2 leading-none d-flex">
            <span class="mt-3 mr-3"><h5 class="mb-0 text-dark getFullName"
                                        style="text-decoration: underline"></h5>
            </span>

            <span>
				<img src="" alt="profile-user"
                     class="getUserProfile avatar profile-user brround cover-image">
			</span>
        </a>
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
            ...
            <form id="logout-desktop">
                <a class="dropdown-item" href="#">
                    ...
                    <input type="submit" name="submit" value="Signout"
                           class="bg-transparent border-0 w-100 text-left signout" style="margin-left: -7px;">
                </a>
            </form>
        </div>
    </div>
