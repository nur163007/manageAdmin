                ...
                <div class="text-center">
                    <div class="userprofile">
                        ...
                        <div class="userpic  brround" style="margin-bottom: 40px;">
                            <img src="" alt="" class="userpicimg getUserProfile" style="height: 120px;width: 120px;">
                ...
                <div class="memberblock mb-0">
                    <div class="row ">
                        ...
                        <div class="bg-white mainDiv">
                            ...
                            <input type="file" name="front_nid" id="front_nid" class="my_file" onchange="displayFrontPart(this)">
                        </div>
                        <div class="bg-white mainDiv" id="back_part">
                            <img src="" alt="TAKE BACK PAGE OF NATIONAL ID" id="showBackNid">
                            <input type="file" name="back_nid" id="back_nid" class="my_file" onchange="displayBackPart(this)">
                        </div>
                    </div>
                </div>
