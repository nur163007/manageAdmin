            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-lg-6 text-right">
                        <button class="btn btn-info" data-target="#userForm" data-toggle="modal"
                                data-original-title="Add New user" onclick="ResetForm();">
                                        ...
                                        <div class="col-md-6 row mt-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="firstname" id="firstname"
                                                       placeholder="give first name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 row mt-3">
                                        ...
                                        <div class="col-md-6 row mt-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="email" class="form-control" name="email" id="email"
                                                       placeholder="give email" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 row mt-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="password" class="form-control" name="password"
                                                       id="password" placeholder="give password" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 row mt-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="department"
                                                       id="department" placeholder="give department">
                                            </div>
                                        </div>
                                        <div class="col-md-6 row mt-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="designation"
                                                       id="designation" placeholder="give designation">
                                            </div>
                                        </div>
                                        <div class="col-md-6 row mt-3">
